Algoritmo club
	...
	Leer tipoEntrada                        						       // Se lee el valor Inicial Para el tipo de Entrada a comprar 
	...
	nombreEntrada= ""        
	tipoEntrada = mayusculas(tipoEntrada)    				// Se utiliza la funcion Mayusculas para asignar  que la letra sea mayuscula en esta variable
